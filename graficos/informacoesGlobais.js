...
async function visualizarDadosGlobais(){
    ...
    paragrafo.innerHTML = 'você sabbia que o mundo tem ${totalPessoasMundo} de habitantes e destes ${totalPessoasConectadas} estão conectadas a alguma rede social e ficam em méedia ${tempoMedio} conectadas.'
